...
class _MemberApiService implements MemberApiService {
  ...
  Future<ApiResponse<List<MemberModel>>> getAll({
    ...
    final _options = _setStreamType<ApiResponse<List<MemberModel>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late ApiResponse<List<MemberModel>> _value;
    try {
      _value = ApiResponse<List<MemberModel>>.fromJson(
        _result.data!,
        (json) => json is List<dynamic>
            ? json
                .map<MemberModel>(
                    (i) => MemberModel.fromJson(i as Map<String, dynamic>))
                .toList()
            : List.empty(),
      );
    } on Object catch (e, s) {
  ...
  @override
  Future<ApiResponse<dynamic>> add(MemberRequestParam param) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<ApiResponse<MemberModel>> getById(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<ApiResponse<dynamic>> remove(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
